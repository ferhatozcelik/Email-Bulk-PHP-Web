...
<body>
  <div class="wrapper">
    ...
    <form class="form" id="form">
      ...
      <a href='home-single.php' class="my-btn" style="width: 100%; margin: 8px">
        Email Send Single
      </a>
      ...
      $query = "SELECT * FROM bulk_email_list  WHERE `user_id`='{$userId}'GROUP BY `group`";
      ...
      ?>
        ...
        <div id="email-group" class="input-box">
          <?php
          foreach ($query_run as $bulk_email_list) {
          ?>
            <div class="input-box" style="padding: 2px;">
              <input type="radio" id=<?= $bulk_email_list['group']; ?> name="email-group" value=<?= $bulk_email_list['group']; ?> required>
              <label for=<?= $bulk_email_list['group']; ?> class="my-btn btn-sm"><?= $bulk_email_list['group']; ?></label><br>
            </div>
          <?php
          }
          ?>
      ...
      ?>
        <div class="alert" style="margin: 16px">Not Found Email List</div>
      <?php
      }
      ?>
    </form>
